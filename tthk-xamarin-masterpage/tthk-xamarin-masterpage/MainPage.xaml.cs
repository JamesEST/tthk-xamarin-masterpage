...
namespace tthk_xamarin_masterpage
{
    public partial class MainPage : MasterDetailPage
    {
        ...
        public MainPage()
        {
            ...
            var page1 = new MasterPageItem() { Id = 1, Title = "Bmw", Icon = "bmw.png" };
            var page2 = new MasterPageItem() { Id = 2, Title = "Audi", Icon = "audi.png" };
            var page3 = new MasterPageItem() { Id = 3, Title = "Ford", Icon = "ford.png" };
            var page4 = new MasterPageItem() { Id = 4, Title = "Tesla", Icon = "tesla.png" };
            var page5 = new MasterPageItem() { Id = 5, Title = "Lexus", Icon = "lexus.png" };
            var page6 = new MasterPageItem() { Id = 6, Title = "Toyota", Icon = "toyota.png" };
            var page7 = new MasterPageItem() { Id = 7, Title = "Nissan", Icon = "nissan.png" };
            var page8 = new MasterPageItem() { Id = 8, Title = "Renault", Icon = "renault.png" };
            var page9 = new MasterPageItem() { Id = 9, Title = "Peugeot", Icon = "peugeot.png" };
            var page10 = new MasterPageItem() { Id = 10, Title = "Chevrolet", Icon = "chevrolet.png" };
